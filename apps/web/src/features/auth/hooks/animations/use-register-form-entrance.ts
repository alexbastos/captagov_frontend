...
function useRegisterFormEntrance(scope?: RefObject<HTMLElement | null>) {
  ...
  useGSAP(
    () => {
      ...
      media.add("(prefers-reduced-motion: no-preference)", () => {
        ...
        const steps = gsap.utils.toArray<HTMLElement>("[data-register-step]")
        ...
        unregisterMotion = registerMotion("register-form-entrance", {
...
export { useRegisterFormEntrance }
