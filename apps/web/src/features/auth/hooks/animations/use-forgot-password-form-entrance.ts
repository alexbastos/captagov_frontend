...
function useForgotPasswordFormEntrance(scope?: RefObject<HTMLElement | null>) {
  ...
  useGSAP(
    () => {
      ...
      media.add("(prefers-reduced-motion: no-preference)", () => {
        ...
        const steps = gsap.utils.toArray<HTMLElement>("[data-forgot-password-step]")
        ...
        unregisterMotion = registerMotion("forgot-password-form-entrance", {
...
export { useForgotPasswordFormEntrance }
