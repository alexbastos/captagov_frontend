...
function useResetPasswordFormEntrance(scope?: RefObject<HTMLElement | null>) {
  ...
  useGSAP(
    () => {
      ...
      media.add("(prefers-reduced-motion: no-preference)", () => {
        ...
        const steps = gsap.utils.toArray<HTMLElement>("[data-reset-password-step]")
        ...
        unregisterMotion = registerMotion("reset-password-form-entrance", {
...
export { useResetPasswordFormEntrance }
